...
export const profile = {
  ...
  bio: {
    en: 'His research focuses on AI4Science and hypergraph computation — taking hypergraphs as a new tool for scientific discovery and exploring high-order-correlation-driven computing paradigms, with applications in complex network analysis, protein structure modeling, and tumor microenvironment analysis. He leads an NSFC General Program project, an NSFC Young Student Basic Research Program (PhD Candidate) project, a Postdoctoral Innovation Talent Support Program project, and a subproject of a national major S&T program. He has published 30+ papers in Nature Communications, IEEE TPAMI, CVPR, ICLR, etc., with 7500+ Google Scholar citations, including 10 first-author papers in IEEE TPAMI and 5000+ citations of his first-author work. He led the development of DeepHypergraph, the first hypergraph computation toolbox, and Hyper-Extract, a hypergraph knowledge reasoning toolkit that ranked 2nd on GitHub Trending.',
    zh: '研究方向为 AI4Science 与超图计算，致力于将超图作为科学发现的新工具，探索高阶关联驱动的科学计算新范式，应用于复杂网络分析、蛋白质结构建模、肿瘤微环境关联解析等场景。主持国自然面上项目、国自然博士生基金、博新计划、国家科技重大专项子课题。在 Nature Communications、IEEE TPAMI、CVPR、ICLR 等国际期刊与会议发表论文 30 余篇，谷歌学术引用 7500 余次，一作发表IEEE TPAMI 10篇，一作论文引用5000余次。主导构建首个超图计算工具箱 DeepHypergraph 与超图知识推理工具库 Hyper-Extract（GitHub 趋势榜全球第二）。',
  } as I18n,
