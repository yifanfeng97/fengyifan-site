...
export const profile = {
  ...
  bio: {
    ...
    zh: [
      ...
      '主持国自然面上项目、国自然博士生基金、国家科技重大专项子课题等。在 Nature Communications、IEEE TPAMI（13 篇）、ICLR 等发表论文 40 余篇，谷歌学术引用 7500 余次，一作论文单篇最高引用 3000 余次。主导构建首个超图计算工具箱 DeepHypergraph 与超图知识推理工具库 Hyper-Extract（GitHub 趋势榜全球第二）。',
